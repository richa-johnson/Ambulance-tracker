            ...
            child: Column(
              children: [
                ...
                Align(
                  ...
                  child: Padding(padding: EdgeInsets.only(left: 40,top: 30),
                    child: Text(
                      "ADD PATIENT DETAILS",
                      style: TextStyle(
                ...
                Align(
                  alignment: Alignment.centerLeft,
                  child: Padding(padding: EdgeInsetsGeometry.only(left: 32),
                    child: ElevatedButton.icon(onPressed: (){
                      ...
                      icon: Icon(Icons.add, color: Color.fromRGBO(255, 255, 255, 1),),
                      label: Text(
                        "ADD",
                        style: TextStyle(color: Color.fromRGBO(255,255,255,1.0), fontSize: 20),),
